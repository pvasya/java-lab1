...
public class Main {
    public static void main(String[] args) {
        ...
        GameRoom.addToy(new BouncyCar("Large Car1", 350, AGE_GROUP.KIDS, SIZE.LARGE));
        GameRoom.addToy(new BouncyCar("Medium Car1", 20, AGE_GROUP.TEENS, SIZE.MEDIUM));
        GameRoom.addToy(new BouncyCar("Small Car2", 40, AGE_GROUP.TODDLERS, SIZE.SMALL));
        GameRoom.addToy(new BouncyCar("Medium Car2", 70, AGE_GROUP.TODDLERS, SIZE.MEDIUM));
        ...
        GameRoom.addToy(new BouncyCar("Big Car3", 52, AGE_GROUP.KIDS, SIZE.LARGE));
        GameRoom.addToy(new BouncyCar("Standart Car3", 53, AGE_GROUP.KIDS, SIZE.MEDIUM));
        GameRoom.addToy(new BouncyCar("Mini Car4", 55, AGE_GROUP.TEENS, SIZE.SMALL));
        GameRoom.addToy(new BouncyCar("Large Car4", 870, AGE_GROUP.TEENS, SIZE.LARGE));
        GameRoom.addToy(new BouncyCar("Mini Car5", 32, AGE_GROUP.TODDLERS, SIZE.SMALL));
        ...
        System.out.println("\nBouncyCar:");
        GameRoom.findToysByType(BouncyCar.class).forEach(System.out::println);
